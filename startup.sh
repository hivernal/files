...
# general packages
sudo pacman -S firefox firefox-i18n-ru firefox-i18n-en-us firefox-spell-ru telegram-desktop gcc gdb nodejs neovim npm python-pip jre-openjdk-headless jre-openjdk jdk-openjdk openjdk-doc openjdk-src libreoffice-still libreoffice-still-ru hunspell hunspell-ru hunspell-en_us thunderbird thunderbird-i18n-ru thunderbird-i18n-en-us vlc rsync git gtk-engine-murrine sassc transmission-gtk gthumb gparted cmake lsd --needed
python3 -m pip install --user --upgrade pynvim

# packages for WM
sudo pacman -S flameshot feh lxsession-gtk3 xorg-xbacklight qt5-ct alacritty xmonad xmonad-contrib xmobar breeze --needed
