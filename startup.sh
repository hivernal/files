...
# packages for WM
# sudo pacman -S flameshot feh lxsession-gtk3 xorg-xbacklight qt5ct alacritty xmonad xmonad-contrib xmobar breeze dmenu lxappearance kvantum --needed
